...
import ru.slava.recipes.AvatarView.utils.StringUtils;

public class AvatarPlaceholder extends ShapeDrawable {
    ...
    public void draw(@NonNull Canvas canvas) {
        if (placeholderBounds == null) {
            placeholderBounds = new RectF(0, 0, getBounds().width(), getBounds().height());
            setAvatarTextValues();
        }
