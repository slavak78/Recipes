package ru.slava.recipes.AvatarView.views;
...
import ru.slava.recipes.AvatarView.AvatarPlaceholder;
import ru.slava.recipes.R;
...
public class AvatarView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        setDefaultBorderValues(context);
        ...
        mainPaint.setColor(ContextCompat.getColor(context, R.color.av_bitmap_background_color));
    ...
    public void setDefaultBorderValues(Context context) {
        defaultBorderColor = ContextCompat.getColor(context, R.color.white_50);
